...
const nextSteps = [
  ...
  { icon: Youtube, text: "Set up your Social Media" },
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative p-1 bg-gradient-to-br from-gray-200 to-gray-300 dark:from-slate-800 dark:to-slate-900 rounded-xl"
      >
          ...
          <ScrollArea className="h-64">
            <div className="prose prose-sm max-w-none dark:prose-invert prose-headings:text-gray-900 prose-p:text-gray-600 dark:prose-headings:text-slate-200 dark:prose-p:text-slate-400">
              ...
              <p>
                ...
                provides tools and opportunities to earn income through
                AI-generated content creation, daily assignments, and referral
                programs.
              </p>
              <h4>2. Admin Responsibilities</h4>
              <ul>
                <li>
                  Complete daily assignments as instructed and maintain an
                  active Social Media with provided content.
                </li>
                <li>
                  Provide accurate personal and payment information and adhere
                  to all platform guidelines.
                </li>
              </ul>
              ...
              <p>
                AI-generated content is licensed for use on your designated
                channel only. The referral system must be used ethically;
                self-referrals and fake accounts are prohibited.
              </p>
              <h4>5. Account Termination</h4>
              <p>
                Violation of terms, fraudulent activity, or prolonged inactivity
              ...
              <p>
                ...
                Policy. We are committed to protecting your data and do not sell
                it to third parties.
              </p>
            </div>
          </ScrollArea>
      ...
      <motion.div
        variants={itemVariants}
        className="flex items-center space-x-4 p-4 bg-gray-100 dark:bg-slate-800/50 border border-gray-200 dark:border-slate-700/80 rounded-xl"
      >
        <Switch
          id="terms-acceptance"
          checked={accepted}
      ...
      <motion.div
        variants={itemVariants}
        className="p-6 bg-gray-100 dark:bg-slate-800/50 border border-gray-200 dark:border-slate-700/80 rounded-xl"
      >
        <h3 className="font-semibold text-gray-800 dark:text-slate-200 mb-4 text-center">
          What Happens Next?
        </h3>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
          {nextSteps.map((step, index) => (
            <div
              key={index}
              className="flex flex-col items-center p-3 bg-gray-200/70 dark:bg-slate-700/50 rounded-md"
            >
      ...
      <motion.div variants={itemVariants} className="flex space-x-4 mt-8">
        <Button
          variant="outline"
          onClick={onBack}
          className="w-full text-gray-700 dark:text-slate-300 border-gray-300 dark:border-slate-700 hover:bg-gray-100 dark:hover:bg-slate-800 hover:text-gray-900 dark:hover:text-white"
