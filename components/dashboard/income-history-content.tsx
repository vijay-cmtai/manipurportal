...
const transactions = [
  {
    ...
    amount: -5000,
    status: "Completed",
    description: "UPI Withdrawal to John Doe@paytm",
  },
  {
    id: "TXN003",
    date: "2024-07-14",
    ...
    amount: 120,
    status: "Completed",
    description: "Level 1 Referral Commission (REF***789)",
  },
  {
    id: "TXN004",
    date: "2024-07-13",
    ...
    amount: 1500,
    status: "Completed",
    description: "YouTube Revenue Share - July Week 2",
  },
  {
    id: "TXN006",
    date: "2024-07-12",
    ...
    amount: 50,
    status: "Completed",
    description: "Level 2 Referral Commission (REF***012)",
  },
  {
    id: "TXN007",
    date: "2024-07-11",
  ...
  },
  {
    ...
    amount: 250,
    status: "Completed",
    description: "Level 1 Referral Commission (REF***345)",
  },
  {
    id: "TXN010",
    date: "2024-07-08",
  ...
  const summaryCards = [
    {
      ...
      value: incomeSummary.totalBalance,
      color: "text-teal-600 dark:text-teal-400",
    },
    {
      icon: TrendingUp,
      title: "Total Withdrawn",
      value: incomeSummary.totalWithdrawn,
      color: "text-green-600 dark:text-green-400",
    },
    {
      icon: Users,
      title: "Referral Earnings",
      value: incomeSummary.totalReferralEarnings,
    ...
    <div className="space-y-6">
      <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg p-6">
        ...
        <p className="text-gray-600 dark:text-slate-400 text-lg">
          Track all your earnings, withdrawals, and platform transactions.
        </p>
      </div>
      ...
      <Card className="bg-white dark:bg-slate-900 border-gray-200 dark:border-slate-800">
        ...
        <CardContent>
          <div className="overflow-x-auto">
            <Table>
              <TableHeader>
                <TableRow className="border-gray-200 dark:border-slate-800 hover:bg-gray-50 dark:hover:bg-slate-800/50">
              ...
              <TableBody>
                {filteredTransactions.length === 0 ? (
                  <TableRow>
                    ...
                    >
                      <Filter className="h-12 w-12 mx-auto mb-4 text-gray-400 dark:text-slate-600" />
                      <p className="text-lg font-semibold text-gray-800 dark:text-slate-300">
                  ...
                  filteredTransactions.map((txn) => (
                    ...
                    >
                      <TableCell className="font-mono text-xs text-gray-500 dark:text-slate-400">
                        {txn.id}
                      </TableCell>
                      ...
                      <TableCell>
                        <Badge
                          ...
                          className={
                            txn.type === "Credit"
                              ? "text-green-600 border-green-200 dark:text-green-400 dark:border-green-400/50"
                              : "text-red-600 border-red-200 dark:text-red-400 dark:border-red-400/50"
                          }
                        >
                          {txn.type}
                        </Badge>
                      ...
                      <TableCell
                        className={`text-right font-semibold ${txn.type === "Credit" ? "text-green-600 dark:text-green-400" : "text-red-600 dark:text-red-400"}`}
                      >
                        {txn.type === "Credit" ? "+" : ""}₹
                      ...
                      <TableCell>
                        <Badge
                          className={getStatusClasses(txn.status)}
                          variant="outline"
                        >
                          {txn.status}
                        </Badge>
