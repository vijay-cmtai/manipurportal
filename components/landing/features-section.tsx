...
const featuresList = [
  {
    ...
    description:
      "Receive personalized, AI-generated video scripts on trending topics, with optimized titles and tags to maximize your YouTube channel's reach and engagement effortlessly.",
  },
  {
    icon: DollarSign,
    title: "Multiple Income Streams",
    description: "Earn via daily tasks, YouTube monetization, and a transparent multi-level referral commission system.",
  },
  {
    icon: Users,
    title: "Expansive Referral Network",
    description: "Build your downline and earn compounding passive income from 5 levels of successful referrals.",
  },
  {
    icon: TrendingUp,
    title: "Growth Analytics",
    description: "Track your progress with detailed, real-time analytics to optimize your overall earning potential.",
  },
  {
    icon: Shield,
    title: "Fortified Security",
    description: "Your data and earnings are protected with bank-grade security and secure UPI integration.",
  },
]
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-4 text-lg text-gray-600 dark:text-slate-400">
            Our platform is more than just a tool—it's your strategic partner in building a digital empire, one feature at a time.
          </p>
        </div>
            ...
            <FeatureCard>
              <div className="h-full w-full flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-semibold text-gray-900 dark:text-slate-100 mb-2">{mainFeature.title}</h3>
                  <p className="text-gray-600 dark:text-slate-400 leading-relaxed">{mainFeature.description}</p>
                </div>
                <div className="mt-6 h-48 bg-gray-50 dark:bg-slate-900/50 rounded-lg p-4 border border-gray-200 dark:border-slate-700">
                   {/* Dark Mode SVG */}
                   <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" className="hidden dark:block">
                      <defs>
                        <linearGradient id="darkGraphGradient" x1="0%" y1="0%" x2="0%" y2="100%">
                          <stop offset="0%" style={{ stopColor: 'rgba(20, 184, 166, 0.5)' }} />
                          <stop offset="100%" style={{ stopColor: 'rgba(20, 184, 166, 0)' }} />
                        </linearGradient>
                      </defs>
                      <path d="M0 150 C 40 120, 80 100, 120 110 S 200 140, 240 100, 280 40, 320 60, 360 120, 400 130 L 400 180 L 0 180 Z" fill="url(#darkGraphGradient)" stroke="#14b8a6" strokeWidth="2" vectorEffect="non-scaling-stroke" />
                    </svg>
                    {/* Light Mode SVG */}
                    <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" className="dark:hidden">
                      <defs>
                        <linearGradient id="lightGraphGradient" x1="0%" y1="0%" x2="0%" y2="100%">
                          <stop offset="0%" style={{ stopColor: 'rgba(99, 102, 241, 0.4)' }} />
                          <stop offset="100%" style={{ stopColor: 'rgba(99, 102, 241, 0)' }} />
                        </linearGradient>
                      </defs>
                      <path d="M0 150 C 40 120, 80 100, 120 110 S 200 140, 240 100, 280 40, 320 60, 360 120, 400 130 L 400 180 L 0 180 Z" fill="url(#lightGraphGradient)" stroke="#6366f1" strokeWidth="2" vectorEffect="non-scaling-stroke" />
                    </svg>
                </div>
              </div>
            </FeatureCard>
          ...
          {otherFeatures.map((feature, index) => (
            <motion.div key={index} variants={itemVariants}>
              <FeatureCard>
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-slate-100 mb-2">{feature.title}</h3>
